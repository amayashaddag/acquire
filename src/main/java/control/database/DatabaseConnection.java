...
public class DatabaseConnection {
    ...
    public static final String UID_PLAYER_FIELD = "uid";
    public static final String PSEUDO_PLAYER_FIELD = "pseudo";
    public static final String GAME_ID_FIELD = "game-id";
    public static final String STOCKS_TABLE_NAME = "stocks";
    public static final String PLAYER_CASH_FIELD = "cash";
    public static final String PLAYER_NET_FIELD = "net";
    public static final String PLAYER_TABLE_NAME = "players";
    public static final String GAME_TABLE_NAME = "games";
    public static final String GAME_MAX_PLAYERS_FIELD = "max-players";
    public static final String GAME_STATE_FIELD = "state";
    public static final String CORPORATION_FIELD = "corporation";
